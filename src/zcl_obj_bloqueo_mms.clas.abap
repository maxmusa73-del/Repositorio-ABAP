CLASS zcl_obj_bloqueo_mms DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_obj_bloqueo_mms IMPLEMENTATION.
  ...
  data(lo_lock_object) = cl_abap_lock_object_factory=>get_instance( exporting iv_name = 'EZINV_MMS' ).
